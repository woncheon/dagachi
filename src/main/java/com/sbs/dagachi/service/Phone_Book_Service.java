...
public class Phone_Book_Service {
	...
	public List<Phone_BookVO>getPhoneBookList(String searchType, String keyword, int phone_book_type, String phone_book_register, int itemsCountInAPage, int page){
		...
		return phone_Book_Repository.getPhoneBookList(searchType,keyword,phone_book_type,phone_book_register,limitStart,limitTake);
	}
	...
	public int getPhoneBookCount(String searchType, String keyword, int phone_book_type) {
